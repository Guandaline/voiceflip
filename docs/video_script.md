...
* **[Camera ON]**
* "Hi team, I'm Maō. Thank you for the opportunity to present my solution for the Citation Guardrail Engine."
...
* **[Action: Run `python scripts/eval.py`]**
...
* "The most dangerous failure mode is 'Silent Degradation'. If our embedding API fails, the system correctly falls back to lexical keyword matching. However, if this outage persists silently, we might start injecting incorrect citations based purely on keyword overlap (false positives). 
